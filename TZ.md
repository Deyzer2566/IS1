...
- Рассчитать сумму значений поля numberOfRooms для всех объектов.
- Вернуть количество объектов, значение поля view которых меньше заданного.
- Вернуть массив объектов, значение поля timeToMetroByTransport которых меньше заданного.
- Найти самую дешёвую квартиру с балконом.
